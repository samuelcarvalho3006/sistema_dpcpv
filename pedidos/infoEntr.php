...
<body>
    ...
    <h3 class="text-center mb-5">Informações de Entrega</h3>
    </div>
    <?php if ($erro): ?>
            ...
            <?php foreach ($registros as $registro): ?>
                <div class="row row-custom">
                    <div class="col-custom"> <!-- Primeira Coluna -->
                        ...
                        <div class="form-group mb-3">
                            <p><strong>Forma:</strong> <?php echo htmlspecialchars($registro['entrega']); ?></p>
                        </div>
                        <div class="form-group mb-3">
                            <p><strong>Logradouro:</strong> <?php echo htmlspecialchars($registro['logradouro']); ?></p>
                        </div>
                        <div class="form-group mb-3">
                            <p><strong>Número:</strong> <?php echo htmlspecialchars($registro['numero']); ?></p>
                        </div>
                        <div class="form-group mb-3">
                            <p><strong>Bairro:</strong> <?php echo htmlspecialchars($registro['bairro']); ?></p>
                        </div>
                        <div class="form-group mb-3">
                            <p><strong>Cidade:</strong> <?php echo htmlspecialchars($registro['cidade']); ?></p>
                        </div>
                        <div class="form-group mb-3">
                            <p><strong>Estado:</strong> <?php echo htmlspecialchars($registro['estado']); ?></p>
                        </div>
                        <div class="form-group mb-3">
                            <p><strong>CEP:</strong> <?php echo htmlspecialchars($registro['cep']); ?></p>
                        </div>
                    </div>
                </div>
            </div>
